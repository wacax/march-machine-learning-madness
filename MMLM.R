...
download.file(thePredictionTracker, paste0(dataDirectory, 'predictionTracker.csv'))
...
download.file(sagarinPredictiveRankings, paste0(dataDirectory, 'sagarinRankings.csv'))
...
download.file(ordin
              alRankingsKMcore33, paste0(dataDirectory, 'core33.csv'))
...
download.file(ordinalRankingsKMNonCore, paste0(dataDirectory, 'nonCore.csv'))
