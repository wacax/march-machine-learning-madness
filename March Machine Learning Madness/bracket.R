rm(list=ls())
submission<-read.csv("C:\\Users\\Jason\\Desktop\\madness\\sample_submission.csv")
teams<-read.csv("C:\\Users\\Jason\\Desktop\\madness\\teams.csv")
seeds<-read.csv("C:\\Users\\Jason\\Desktop\\madness\\tourney_seeds.csv")
pdf("C:\\Users\\Jason\\Desktop\\madness\\bracket.pdf",width=11,height=8.5)
tgtseason<-"Q"
